...
import { BlockyTabs, TabItem, ZoneId } from './BlockyTabs';
...
const createTab = (id: string, label: string, color: string, icon?: string): TabItem => ({
    id,
    label,
    color,
    icon,
...
const initialTabs: Record<ZoneId, TabItem[]> = {
    ...
    right: [
        createTab('r1', 'Food', '#B5651D', logImg),
    ],
    bottom: [

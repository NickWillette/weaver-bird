...
const FULL_SHEEP_JEM = {
  textureSize: [64, 32] as [number, number],
  models: [
    {
      part: "body",
      id: "body",
      invertAxis: "xy",
      translate: [0, -19, -2] as [number, number, number],
      submodels: [
        {
          id: "rotation",
          invertAxis: "xy",
    ...
    },
    {
      ...
      id: "head",
      invertAxis: "xy",
      translate: [0, -18, 8] as [number, number, number],
      boxes: [
        {
          coordinates: [-3, 16, -14, 6, 6, 8] as [
            number,
            number,
            number,
            number,
    ...
    },
    {
      ...
      id: "leg1",
      invertAxis: "xy",
      translate: [-3, -12, -7] as [number, number, number],
      boxes: [
        {
          coordinates: [1, 0, 5, 4, 12, 4] as [
            number,
            number,
            number,
            number,
          ...
          textureOffset: [0, 16] as [number, number],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      id: "leg3",
      invertAxis: "xy",
      translate: [-3, -12, 5] as [number, number, number],
      boxes: [
        {
          coordinates: [1, 0, -7, 4, 12, 4] as [
            number,
            number,
            number,
            number,
...
// Sheep with wool layer - demonstrates sizeAdd property
const SHEEP_WOOL_JEM = {
  textureSize: [64, 32] as [number, number],
  models: [
    {
      part: "body",
      ...
      boxes: [
        {
          ...
          textureOffset: [0, 0] as [number, number],
          sizeAdd: 0.6, // Thinner wool on head
        },
      ],
    },
    {
      ...
      boxes: [
        {
          ...
          textureOffset: [0, 16] as [number, number],
          sizeAdd: 0.5, // Minimal wool on legs
        },
      ],
    },
    {
...
// Sheep undercoat - thin layer for dyeable skin/base
const SHEEP_UNDERCOAT_JEM = {
  textureSize: [64, 32] as [number, number],
  models: [
    {
      part: "body",
          ...
          boxes: [
            {
              ...
              textureOffset: [28, 8] as [number, number],
              sizeAdd: 0.0, // Thin undercoat layer
            },
          ],
        },
      ],
